    ...
    public class Fader : MonoBehaviour
    {
        ...
        public IEnumerator StartFade(FadeSettings fadeSettings)
        {
            ...
            if (fadeSettings.colorFade)
            {
                ...
                {
                    FadingColor = FadingColor.MoveTowards(fadeSettings.endColor, Time.deltaTime * fadeSettings.fadeInSpeed);
                ...
                if (!fadeSettings.oneWayFade)
                {
                    ...
                    {
                        yield return new WaitForSeconds(fadeSettings.fadeOutWait);
                    }

                    while (!FadingColor.Equals(fadeSettings.startColor))
                    {
                        FadingColor = FadingColor.MoveTowards(fadeSettings.startColor, Time.deltaTime * fadeSettings.fadeInSpeed);
                        OnColorFade?.Invoke(FadingColor);
                        yield return null;
                    }
            ...
            else
            {
                ...
                {
                    FadingValue = Mathf.MoveTowards(FadingValue, fadeSettings.endValue, Time.deltaTime * fadeSettings.fadeInSpeed);
                ...
                if (!fadeSettings.oneWayFade)
                {
                    ...
                    {
                        FadingValue = Mathf.MoveTowards(FadingValue, fadeSettings.startValue, Time.deltaTime * fadeSettings.fadeOutSpeed);
                        OnFade?.Invoke(FadingValue);
                        yield return null;
                    }
